...
function init() {
  return __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, "Hello, world!"), document.getElementById('app'));
}
